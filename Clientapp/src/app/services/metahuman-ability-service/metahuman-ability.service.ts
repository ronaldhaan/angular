...
export class MetahumanAbilityService {
  ...
  static getObject(ability: Ability | string, meta: Metahuman | string): MetahumanAbility {
  ...
  add (ability: Ability | string, meta: Metahuman | string): Observable<MetahumanAbility> {
    const metaAbility = MetahumanAbilityService.getObject(ability, meta);
  ...
  remove(ability: Ability | string, meta: Metahuman | string): Observable<MetahumanAbility> {
    const metaAbility: MetahumanAbility = MetahumanAbilityService.getObject(ability, meta);
